...
population_query_engine.query("What is the population of China in 2023?")
...
tools = [
    ...
    QueryEngineTool(
        ...
        metadata=ToolMetadata(
            ...
            description="This tool can give you information about the population of a country in a given year."
    )),
    QueryEngineTool(
